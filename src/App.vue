...
<template>
  ...
  <ul>
    ...
    <li v-for="movie in this.state.movies">
      ...
      <div v-if="movie.original_language.toUpperCase() === 'IT'">LINGUA: {{ movie.original_language.toUpperCase() }}<img
      ...
      <div v-else-if="movie.original_language.toUpperCase() === 'FR'">LINGUA: {{ movie.original_language.toUpperCase() }}<img
      ...
      <div v-else-if="movie.original_language.toUpperCase() === 'EN'">LINGUA: {{ movie.original_language.toUpperCase() }}<img
      ...
      <div v-else-if="movie.original_language.toUpperCase() === 'ES'">LINGUA: {{ movie.original_language.toUpperCase() }}<img 
...
<style lang="scss">@use './assets/scss/app.scss'</style>
