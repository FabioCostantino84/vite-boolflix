...
<template>
  ...
  <div class="container">
      ...
      <div v-for="movie in this.state.movies" class="col-2">
        ...
        <div class="card" >
          ...
          <!-- <img
            ...
            <div v-else-if="movie.original_language.toUpperCase() === 'FR'">LINGUA: {{
            ...
            <div v-else-if="movie.original_language.toUpperCase() === 'EN'">LINGUA: {{
              movie.original_language.toUpperCase()
            }}<img
            ...
            <div v-else-if="movie.original_language.toUpperCase() === 'ES'">LINGUA: {{
              movie.original_language.toUpperCase()
            }}<img
            ...
            <div v-else-if="movie.original_language.toUpperCase() === 'JA'">LINGUA: {{
              movie.original_language.toUpperCase()
            }}<img
            ...
            <div v-else-if="movie.original_language.toUpperCase() === 'DE'">LINGUA: {{
              movie.original_language.toUpperCase()
            }}<img
            ...
            <div v-else="movie.original_language.toUpperCase()">LINGUA: {{ movie.original_language.toUpperCase() }}
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div v-for="tv in this.state.tvS" class="col-2">
        ...
        <div class="card" @mouseover="showInfo = true" @mouseleave="showInfo = false">
          ...
          <div class="card-body" v-if="showInfo">
            ...
            <div v-else-if="tv.original_language.toUpperCase() === 'FR'">LINGUA: {{ tv.original_language.toUpperCase()
            }}<img
                src="data:image/png;base64,">
            </div>

            <div v-else-if="tv.original_language.toUpperCase() === 'EN'">LINGUA: {{ tv.original_language.toUpperCase()
            }}<img
                src="data:image/png;base64,">
            </div>

            <div v-else-if="tv.original_language.toUpperCase() === 'ES'">LINGUA: {{ tv.original_language.toUpperCase()
            }}<img
                src="data:image/png;base64,">
            </div>

            <div v-else-if="tv.original_language.toUpperCase() === 'JA'">LINGUA: {{ tv.original_language.toUpperCase()
            }}<img
                src="data:image/png;base64,">
            </div>

            <div v-else-if="tv.original_language.toUpperCase() === 'DE'">LINGUA: {{ tv.original_language.toUpperCase()
            }}<img
                src="data:image/png;base64,">
            </div>

            <div v-else="tv.original_language.toUpperCase()">LINGUA: {{ tv.original_language.toUpperCase() }}
            </div>
          </div>
        </div>
