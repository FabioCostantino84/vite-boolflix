...
<template>
    ...
    <div v-for="movie in this.state.movies" class="col-2 p-0">
        <div class="card">
            <img :src="movie.poster_path ? 'https://image.tmdb.org/t/p/w342/' + `${movie.poster_path}` : 'https://upload.wikimedia.org/wikipedia/commons/e/ec/Error-icon.png'"
    ...
    <div v-for="tv in this.state.tvS" class="col-2 p-0">
        <div class="card">
            <img :src="tv.poster_path ? 'https://image.tmdb.org/t/p/w342/' + `${tv.poster_path}` : 'https://upload.wikimedia.org/wikipedia/commons/e/ec/Error-icon.png'"
                alt="Immagine di Copertina">
